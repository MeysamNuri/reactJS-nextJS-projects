...
interface IDetailCapialIncreaseProps {
  selectedRequest: any;
  detailRequestGetWay?: any;
  modelExpertGrid?: any;
  closeModal?: () => void
}
const DetailCapialIncrease: FC<IDetailCapialIncreaseProps> = ({
  selectedRequest,
  detailRequestGetWay,
  modelExpertGrid,
  closeModal
    ...
    <div>
      ...
      <Collapse defaultActiveKey={["1", "2", "3"]}  >
        <Panel header="اطلاعات درخواست تغییر مدیر شعبه" key="1">
          ...
          <Row gutter={16}>
            <Col className="gutter-row" span={6}>
              <div className="titles">افزایش سرمایه </div>
              <span className="contentColumns">
                {selectedRequest?.CapitalIncrease?.Capital !==
                  undefined ? (
                    <span>
                      {" "}
                      {selectedRequest?.CapitalIncrease?.Capital }
...
export default DetailCapialIncrease;
