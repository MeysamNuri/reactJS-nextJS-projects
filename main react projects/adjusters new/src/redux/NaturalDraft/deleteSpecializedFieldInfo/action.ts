...
export const deleteSpecializedFieldInfoEdit = (
  ...
  try {
    dispatch({
      type: DELETE_NATURAL_SPECIALIZED_FIELD_INFO,
    });
    ...
    dispatch({
      type: DELETE_NATURAL_SPECIALIZED_FIELD_INFO_SUCCESS,
      payload: data,
    });
    ...
    failedFunction();
    dispatch({
      type: DELETE_NATURAL_SPECIALIZED_FIELD_INFO_FAILED,
      payload:
