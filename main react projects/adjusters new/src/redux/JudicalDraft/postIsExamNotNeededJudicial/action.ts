...
export const postIsExamNotNeededEditJudicial = (
  dataToPost: any,
  successFunction: () => void
) => async (dispatch: any) => {
  try {
    dispatch({
      type: POST_IS_EXAM_NOT_NEEDED_EDIT_JUDICIAL,
    });
    ...
    dispatch({
      type: POST_IS_EXAM_NOT_NEEDED_EDIT_JUDICIAL_SUCCESS,
      payload: data,
    });
    ...
    dispatch({
      type: POST_IS_EXAM_NOT_NEEDED_EDIT_JUDICIAL_FAILED,
      payload:
