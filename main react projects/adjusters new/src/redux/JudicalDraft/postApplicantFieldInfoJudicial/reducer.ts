...
export default (state = INIT_STATE, action: any) => {
  switch (action.type) {
    case POST_APPLICANT_FIELD_INFO_FIELD_JUDICIAL_INFO:
      return { ...state, loading: true };
    case POST_APPLICANT_FIELD_INFO_FIELD_JUDICIAL_INFO_SUCCESS:
      return { ...state, loading: false, specializedFieldInfo: action.payload };
    case POST_APPLICANT_FIELD_INFO_FIELD_JUDICIAL_INFO_FAILED:
