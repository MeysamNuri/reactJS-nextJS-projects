...
import { deleteApiUser, selectAllUsers,addNewApiUser } from '../reducers/userSlice';
        ...
        <section>
            <div>
                <form action="">
                    ...
                    <button type='button' onClick={handleSubmitForm} disabled={!canSave}>ساخت نویسنده</button>
                </form>
            </div>
