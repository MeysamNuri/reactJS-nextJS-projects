...
import { Pagination, ConfigProvider, Spin, Alert, Empty,  } from "antd";
import { fetchListNaturalCartable } from "../../../redux/actions";
...
import { DATA_NATURAL_CARTABLE } from "../../../constant/cartableActionTypes";
...
const Natural: FC<INaturalProps> = ({activeTabInbox }) => {
            ...
            ? [
                {
                  ...
                  operator: 1,
                  value: GetInbox.inbox,
                },
              ]
            : modelFilterNaturalCartable?.advancedSearchModel.filters,
      },
    };
  }, [pageModel, modelFilterNaturalCartable]);

  useEffect(() => {
    activeTabInbox === "1" &&
      dispatch({ type: DATA_NATURAL_CARTABLE, payload: dataNaturalCartable });
  }, [pageModel, activeTabInbox]);

  useEffect(() => {
    activeTabInbox === "1" &&
      dispatch(fetchListNaturalCartable(dataNaturalCartable, () => {}));
  }, [pageModel, activeTabInbox]);
