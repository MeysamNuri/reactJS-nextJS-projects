...
import { fetchSmsOutBoxListApplicantId } from "../../../redux/actions";
...
const SmsOutBoxApplicantId: FC<ISmsOutProps> = ({ applicantId }) => {
  const dispatch = useDispatch();
  const {
    smsOutBoxListApplicantId,
    loadingSmsOutBoxListApplicantId,
  ...
  let sms = smsOutBoxListApplicantId?.Result?.map((sms: ISms) => {
    let obj = {
      key: sms.Id,
  ...
  useEffect(() => {
    ...
    dispatch(fetchSmsOutBoxListApplicantId(dataMode)); 
  }, [pageModel]);
    ...
    <div>
      <ConfigProvider direction="rtl">
        <Table
          ...
          loading={loadingSmsOutBoxListApplicantId}
          pagination={{
            pageSize: pageModel.pageSize,
            total: smsOutBoxListApplicantId?.TotalCount,
          ...
          locale={{
            ...
            emptyText:
              smsOutBoxListApplicantId?.IsSucceed === false
                ? smsOutBoxListApplicantId.Message
                : "پیامی وجود ندارد",
          }}
        />
      </ConfigProvider>
...
export default SmsOutBoxApplicantId;
