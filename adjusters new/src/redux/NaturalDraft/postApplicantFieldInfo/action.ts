...
export const postApplicantFieldInfoEdit = (
  ...
  try {
    dispatch({
      type: POST_APPLICANT_FIELD_INFO_FIELD_INFO,
    });
    ...
    dispatch({
      type: POST_APPLICANT_FIELD_INFO_FIELD_INFO_SUCCESS,
      payload: data,
    });
    ...
    dispatch({
      type: POST_APPLICANT_FIELD_INFO_FIELD_INFO_FAILED,
      payload:
