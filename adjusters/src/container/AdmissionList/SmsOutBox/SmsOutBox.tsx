...
import { fetchSmsOutBoxList } from "../../../redux/actions";
...
const SmsOutBox: FC<ISmsProps> = ({ isManagmentCartable,applicantId }) => {
  ...
  const { smsOutBoxList, loading } = useSelector(
  ...
  let sms = smsOutBoxList?.Result?.map((sms: ISms) => {
    let obj = {
      key: sms.Id,
    ...
    <div>
      <ConfigProvider direction="rtl">
        <Table
          ...
          pagination={{
            pageSize: pageModel.pageSize,
            total: smsOutBoxList?.TotalCount,
