...
const CreatNotificationMoal: React.FC<CreatNotificationMoalProps> = ({ showNoticDetails, onCancel, type, modelRequest, selectedRecord, removeSelectedRecord, disableDeletefiles }) => {
    ...
    console.log(noticState, "noticState");
    console.log(notificationDetailsInfo, "notificationDetailsInfo");
    ...
    const handleNoticState = (e: any) => {

        setNoticState(e.target.checked)
    }
    useEffect(() => {
    ...
    console.log(notificationDetailsInfo?.Result?.IsActive, "notificationDetailsInfo?.Result?.IsActive");
